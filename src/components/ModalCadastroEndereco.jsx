                ...
                <div className="modalCadastroEnderecoBody">
                    <div className="modalCadastroEnderecoBodyContainer">
                        <div className="modalCadastroEnderecoBodyContainerCep">
                            ...
                            <input maxLength='9'type="text" id="cep" name="cep" value={cep} onChange={formatCep} />
                        ...
                        <div className="modalCadastroEnderecoBodyContainerLogradouro">
                            ...
                            <input type="text" id="logradouro" name="logradouro" value={logradouro} onChange={(e) => {setLogradouro(e.target.value)}} />
                        </div>
                        ...
                        <div className="modalCadastroEnderecoBodyContainerBairro">
                            ...
                            <input type="text" id="bairro" name="bairro" value={bairro} onChange={(e) => {setBairro(e.target.value)}} />
                        </div>
                        ...
                        <div className="modalCadastroEnderecoBodyContainerUf">
                            ...
                            <input type="text" id="uf" name="uf" value={uf} onChange={(e) => {setUf(e.target.value)}} />
                        </div>
                    </div>
                </div>
